...
var reloadCallback = function () {
  ...
  $("h3#queries_blocked_exact").text(statistics[2].toLocaleString());
  $("h3#queries_wildcard_blocked").text(statistics[3].toLocaleString());
  ...
  $("h3#queries_percentage_today").text(parseFloat(percent).toFixed(1).toLocaleString() + " %");
};
