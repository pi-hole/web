...
const REFRESH_INTERVAL = {
  ...
  summary: 30000, // 30 sec (dashboard)
  blocking: 30000, // 30 sec (all pages, sidebar)
  metrics: 30000, // 30 sec (settings page)
  system: 60000, // 1 min (all pages, sidebar)
  sensors: 60000, // 1 min (all pages, sidebar)
  query_types: 120000, // 2 min (dashboard)
  upstreams: 120000, // 2 min (dashboard)
  top_lists: 120000, // 2 min (dashboard)
  messages: 120000, // 2 min (all pages)
  ftl: 120000, // 2 min (all pages, sidebar)
  hosts: 120000, // 2 min (settings page)
  version: 300000, // 5 min (all pages, footer)
