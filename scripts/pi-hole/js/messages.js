...
function renderMessage(data, type, row) {
  ...
  switch (row.type) {
    ...
    case "SCRIPT":
      var decodedblob1 = atob(row.blob1);
      return (
        "Warning generated by <code>" +
        decodedblob1 +
        "</code><pre>" +
        row.message +
        '</pre> If the problem persists, please contact <a href="https://discourse.pi-hole.net/latest" target="_blank">support</a>.'
      );
