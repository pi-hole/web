...
<head>
    <meta charset="UTF-8">
    <meta http-equiv="Content-Security-Policy" content="default-src 'self' https://api.github.com http://pihole.speedtestcustom.com; script-src 'self' 'unsafe-eval'; style-src 'self' 'unsafe-inline'">
