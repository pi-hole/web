...
?>
	...
	<!-- Version Infos -->
        ...
        <div style="display: inline-block"><strong><a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&amp;hosted_button_id=3J2L3Z4DHW9UY" target="_blank"><i class="fa fa-paypal"></i> Donate</a></strong> if you found this useful.</div>
    </footer>
</div>
<!-- ./wrapper -->
